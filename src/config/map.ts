...
export const mapConfig = {
  ...
  defaultCenter: [10.735, 36.456] as Coordinates,
  defaultZoom: 11.4,
  minZoom: 5.4,
  maxZoom: 18,
  tunisiaBounds: [
  ...
  categories: [
    ...
    { id: "cafe", label: "Cafes", icon: "Coffee", color: brand.markerStyles.cafe, mapIcon: "cafe-15" },
    ...
    { id: "attraction", label: "Attractions", icon: "Landmark", color: brand.markerStyles.attraction, mapIcon: "attraction-15" },
    { id: "shopping", label: "Shopping", icon: "ShoppingBag", color: brand.markerStyles.shopping, mapIcon: "shop-15" },
    { id: "beach", label: "Beaches", icon: "Waves", color: brand.markerStyles.beach, mapIcon: "beach-15" },
    { id: "other", label: "Other", icon: "MapPin", color: brand.markerStyles.other, mapIcon: "marker-15" },
  ] satisfies CategoryDefinition[],
  regions: [
    {
      id: "nabeul",
      name: "Nabeul",
      center: [10.735, 36.456],
      status: "enabled",
      bounds: [
        [10.32, 36.24],
        [11.16, 36.98],
